function [amb,dem] = aminv_gpu(ama)
...
elseif nx==2
   ...
   a = ama(1,1,:); b = ama(1,2,:); c =ama(1,3,:); 
   d = ama(2,1,:); e = ama(2,2,:); f =ama(2,3,:);  
   g = ama(3,1,:); h = ama(3,2,:); i =ama(3,3,:);
