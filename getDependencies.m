...
if dependency_dir_created && msg == "Directory already exists."
    ...
    for folder=1:numel(folders)
        ...
        for i=1:numel(dir_dep_listing)
            ...
            dir_dep_listing_name(i) = dir_dep_listing(i).name;
        end
...
for i=1:numel(dir_listing)
    ...
    existing_dependencies(end+1) = dir_listing(i).name;
end
...
for i=1:numel(dir_listing)
    ...
    for j=1:numel(file_dependencies)
        ...
        [status,msg] = copyfile(dep_file,dep_dir_name);
        ...
        existing_dependencies(end+1) = dep_file_name;
